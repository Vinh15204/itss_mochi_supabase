...
('Võ Huỳnh Long', '111123456789long@gmail.com', 'K66', 'Kỹ thuật Y sinh', 'Đại học Bách khoa Hà Nội', 'Nền tảng học thuật ngữ chuyên ngành và trích xuất tài liệu', 5, 'Có sẵn gói từ vựng Y khoa rất hiếm trên các app khác', 'Lúc ngồi trên xe buýt tuyến 08 về ký túc xá', 'vocab_bank', 'Kho từ vựng y tế giải phẫu chuẩn xác', 'App khác chỉ có từ vựng giao tiếp, Siuuu có từ chuyên ngành', 'Thêm các đoạn hội thoại chuyên ngành y', '349k_year', 10, 5),
